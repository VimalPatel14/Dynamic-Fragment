...
public class WallPaperDataPagination extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WallPaperDataPagination(Context context, ArrayList<JsonItems> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_MOVIE) {
            return new MovieHolder(inflater.inflate(R.layout.wallpaper_data_adapter, parent, false));
        } else {
