...
import com.vimal.dailyfeed.activity.WallPaperActivity;
import com.vimal.dailyfeed.activity.WallPaperDisplayActivity;
import com.vimal.dailyfeed.model.JsonItems;

import java.io.Serializable;
import java.util.List;

public class WallPaperAdapter extends RecyclerView.Adapter<WallPaperAdapter.MyView> {
    ...
    public WallPaperAdapter(Context context, List<JsonItems> horizontalList) {
    ...
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.wallpaper_items, parent, false);
