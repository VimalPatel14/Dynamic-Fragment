...
public class BottomDialog_Ringtones {
    ...
    ImageView playpause;
    LinearLayout setringtone, share;
    ...
    protected BottomDialog_Ringtones(Builder builder) {
        mBuilder = builder;
    ...
    private Dialog initBottomDialog(final Builder builder) {
        ...
        View view = LayoutInflater.from(builder.context).inflate(R.layout.ringtone_bottom_dialog, null);
        ...
        setringtone = view.findViewById(R.id.setringtone);
        ...
        if (builder.btn_positive != null) {
            ...
            vPositive.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (builder.btn_positive_callback != null)
                        builder.btn_positive_callback.onClick(BottomDialog_Ringtones.this);
            ...
            if (builder.btn_colorPositiveBackground == 0) {
                ...
                builder.btn_colorPositiveBackground = !hasColorPrimary ? v.data : ContextCompat.getColor(builder.context, R.color.purple_200);
            }

            Drawable buttonBackground = UtilsLibrary_Ringtone.createButtonBackgroundDrawable(builder.context, builder.btn_colorPositiveBackground);
        ...
        playpause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (builder.btn_play_pause_callback != null)
                    builder.btn_play_pause_callback.onClick(BottomDialog_Ringtones.this);
            }
        });
        ...
        setringtone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (builder.btn_set_ringtone != null)
                    builder.btn_set_ringtone.onClick(BottomDialog_Ringtones.this);
            }
        });
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (builder.btn_share != null)
                    builder.btn_share.onClick(BottomDialog_Ringtones.this);
            }
        });
            ...
            vNegative.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (builder.btn_negative_callback != null)
                        builder.btn_negative_callback.onClick(BottomDialog_Ringtones.this);
                    if (builder.isAutoDismiss)
                        bottomDialog.dismiss();
                }
            });
    ...
    public static class Builder {
        ...
        protected ButtonCallback btn_negative_callback, btn_positive_callback,
                btn_play_pause_callback, btn_set_ringtone, btn_share;
        ...
        public Builder onPlayPause(@NonNull ButtonCallback buttonCallback) {
            this.btn_play_pause_callback = buttonCallback;
            return this;
        }

        public Builder onSetRingtone(@NonNull ButtonCallback buttonCallback) {
            this.btn_set_ringtone = buttonCallback;
            return this;
        }

        public Builder onShare(@NonNull ButtonCallback buttonCallback) {
            this.btn_share = buttonCallback;
            return this;
        }
        ...
        @UiThread
        public BottomDialog_Ringtones build() {
            return new BottomDialog_Ringtones(this);
        }

        @UiThread
        public BottomDialog_Ringtones show() {
            BottomDialog_Ringtones bottomDialogRingtones = build();
            bottomDialogRingtones.show();
            return bottomDialogRingtones;
        }

    }

    public interface ButtonCallback {
        void onClick(@NonNull BottomDialog_Ringtones dialog);
    }
